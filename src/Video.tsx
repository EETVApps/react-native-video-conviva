  ...
  (
    ...
    const convivaInit = useCallback((customerKey: string, gatewayUrl: string, playerName: string, tags: object, enableDebug: boolean) => {
      ...
      Platform.select({
        ...
        default: () => {
          // TODO: Implement NativeVideoManager.convivaInitFunctionCmd for windows
        },
      })();
    }, []);
    ...
    const reportPlaybackRequested = useCallback((assetName: string, isLive: boolean, tags: object) => {
      ...
      Platform.select({
        ...
        default: () => {
          // TODO: Implement NativeVideoManager.reportPlaybackRequestedCmd for windows
        },
      })();
    }, []);
    ...
    const setPlaybackData = useCallback((streamUrl: string, viewerId: string, tags: object) => {
      ...
      Platform.select({
        ...
        default: () => {
          // TODO: Implement NativeVideoManager.setPlaybackDataCmd for windows
        },
      })();
    }, []);
	...
	const reportWarning = useCallback((message: string) => {
      ...
      Platform.select({
        ...
        default: () => {
          // TODO: Implement NativeVideoManager.reportWarningCmd for windows
        },
      })();
    }, []);
    ...
    const reportError = useCallback((message: string, tags: object) => {
      ...
      Platform.select({
        ...
        default: () => {
          // TODO: Implement NativeVideoManager.reportErrorCmd for windows
        },
      })();
    }, []);
	...
	const reportPlaybackEnded = useCallback(() => {
      ...
      const reportPlaybackEndedFunction = () => {
        NativeVideoManager.reportPlaybackEndedCmd(getReactTag(nativeRef));
      };
      Platform.select({
        ios: reportPlaybackEndedFunction,
        android: reportPlaybackEndedFunction,
        default: () => {
          // TODO: Implement NativeVideoManager.reportPlaybackEndedCmd for windows
        },
      })();
    }, []);
